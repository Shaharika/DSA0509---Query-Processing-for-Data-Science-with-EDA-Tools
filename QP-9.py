...
# with the provided columns and data
...
# Clean up the 'Sale_amt' column by removing commas and converting to float
...
# Display the Pivot table for total sale amount region-wise, manager-wise, and salesperson-wise
